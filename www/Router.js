...
jQuery.sap.declare("sap.ui.apouni.Router");

sap.ui.core.routing.Router.extend("sap.ui.apouni.Router", {
		...
		myNavToWithoutHash : function(oOptions) {
			...
			// navigate to it
			var oView = this.getView(oOptions.targetViewName,
					oOptions.targetViewType);
		...
		_findSplitApp : function(oControl) {
			...
			return oControl.getParent() ? this._findSplitApp(
					oControl.getParent(), sAncestorControlName)
					: null;
		}
});